{
	var _Node=require('./scr/mod/wid/node.js?form');//fake copy for inheritance
	var form=_Node;
	form.prototype.src='./scr/mod/wid/form.js';
	form.prototype.nodename='form';
	form.prototype.init=function(){
		var Node=require('./scr/mod/wid/node.js');//fake orig
