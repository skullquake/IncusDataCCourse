{
	var Node=require('./scr/mod/wid/node.js?table');//fake copy for inheritance
	var Container=require('./scr/mod/wid/container.js');
	var Anchor=require('./scr/mod/wid/anchor.js');
	var table=Node;
	nodename='div';
	table.prototype.src='./scr/mod/wid/table.js';
	...
	table.prototype.setData=function(a){
		var Dbo=require('./scr/mod/orm/dbo.js');
		var dbo=new Dbo();
		dbo.setup({'db':'','tbl':''});
		this.data=a;
		var _this=this;
