...
{
	var Node=require('./scr/mod/wid/node.js?jumbotron');//fake copy for inheritance
	var jumbotron=Node;
	jumbotron.prototype.src='./scr/mod/wid/jumbotron.js';
	...
	jumbotron.prototype.toString=function(idx,idt){
		...
		*/
		...
		var Node=require('./scr/mod/wid/node.js');
